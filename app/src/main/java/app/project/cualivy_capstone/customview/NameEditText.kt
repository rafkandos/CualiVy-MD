package app.project.cualivy_capstone.customview
...
class NameEditText:AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        clearButtonImage = ContextCompat.getDrawable(context, R.drawable.user) as Drawable
        iconFormInput =
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        context.apply {
            ...
            textSize = 16f
            setHintTextColor(ContextCompat.getColor(this, R.color.grey))
